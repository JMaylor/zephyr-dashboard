<template>
  <DashboardCard class="w-full transition-all">
    <h4 class="text-xl font-medium">About</h4>
    <p>
      This is a simple dashboard template, made with Vue 3, Vite, Tailwind and more.
      I plan on using this to get started with any personal projects that would benefit from this kind of layout.
      It is not intended to be a fully-featured dashboard template.
      It is intended to be a flexible starting point for personal projects, using:
    </p>
    <ul class="list-disc list-inside">
      ...
      <li>
        <a href="https://github.com/antfu/unplugin-auto-import" target="_blank">unplugin-auto-import</a>,
        <a
          href="https://github.com/antfu/unplugin-vue-components"
          target="_blank"
        >unplugin-vue-components</a> and
        ...
        <a
          ...
          target="_blank"
        >Anthony Fu</a> which have been game-changers for me in terms of improving Vue 3 development.
      </li>
      <li>
